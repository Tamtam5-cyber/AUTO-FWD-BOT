...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/Ultimatesmmnews')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/Ultimatesmmhelp'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/Ultimatesmmhelp')
        ],[
